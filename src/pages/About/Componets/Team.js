        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="./assets/img/hamza.jpg" alt="Hamza" /></div>
                        <div class="details">
                            <h4>Hamza Anis</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="./assets/img/adeel.png" alt="Adeel" /></div>
                        <div class="details">
                            <h4>Adeel Khan</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="./assets/img/Talha.jpg" alt="Talha" /></div>
                        <div class="details">
                            <h4>Talha Rizwan</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="./assets/img/waleed2.jpg" alt="Waleed" /></div>
                        <div class="details">
                            <h4>Waleed</h4>
                            <span>Team member</span>
                            <div class="social">
